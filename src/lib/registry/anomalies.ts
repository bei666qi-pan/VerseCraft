...
export const ANOMALIES: readonly Anomaly[] = [
  {
    ...
    narrativeRole: "把玩家从普通误入者转成可登记对象，提示公寓先处理身份再处理肉体。此现象并不困于登记口本身：凡是已经不敢确认「今天星期几」的住户，都等于替全楼预支了一份错位——4 楼终年不问日期的张先生，正是这份错位扎根最深的样本。",
  ...
  },
  {
    ...
    narrativeRole: "把 2F 医疗、样本、管道与原石稳定秩序连成一条分拣线。给排水立管贯穿全楼垂直井道，2F 诊室只是它对外登记「样本」的行政前台，7 楼厨房水槽是同一套立管的另一端末梢——多年前正是那里的下水道，拖走了如今值夜剁肉的厨师之妻。",
