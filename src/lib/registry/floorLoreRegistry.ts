...
export const FLOOR_LORE_BY_ID: Record<ThreatAxisFloorId, FloorLoreEntry> = {
  "1": {
    ...
    hiddenCausal: "本层对应摄入登记：公寓先夺取「你是谁」，再处理肉体。登记口只是行政前台，真正被摘走时间感的往往是那些已经不敢确认日期的住户（如4楼张先生），不限于本层物理范围。",
  ...
  "2": {
    ...
    hiddenCausal: "误诊即分拣：评估你适合被哪条管线接收，再用水源把样本送走。管线贯穿全楼垂直井道，本层只是行政前台，7楼厨房水槽是同一套立管的另一端末梢。",
