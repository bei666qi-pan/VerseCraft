...
export const WEAPON_TEMPLATES: readonly WeaponTemplate[] = [
  ...
  },
  {
    ...
    suggestedTier: "C",
    name: "镜背匕",
    description: "借镜像反射确认方位，适合对抗镜像反制型主威胁。",
    counterThreatIds: ["A-005"],
  ...
  {
    templateId: "tpl.cognition.mind_spike",
    suggestedTier: "C",
    name: "理神针",
    description: "锚定认知与精神坐标，适合对抗认知侵蚀与精神压迫型主威胁。",
    counterThreatIds: ["A-008"],
    counterTags: ["cognition", "anchor"],
    stability: 72,
    calibratedThreatId: null,
    modSlots: ["core", "surface"],
    currentMods: [],
