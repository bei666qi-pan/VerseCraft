...
export const IMMUTABLE_ROOT_CANON: readonly ImmutableRootCanonEntry[] = [
  ...
  },
  {
    ...
    title: "玩家回声体",
    truth:
      "玩家不是普通住户，而是被碎片捕获的外来回声体（主锚）。「外来」是公寓收容秩序对其的归类，不等同于与耶里学校毫无瓜葛——回声体特指同一场耶里泄露里被循环剥离次数远超六名辅锚、因而无法再稳定挂靠任一固定相位的残响本体，公寓系统才将其单独标定为主锚。强处在于难以被循环彻底抛弃、可保留碎片化记忆、对空间褶皱敏感；非典型无限成长战力模板，秩序与资源裁决仍服从系统。",
  },
] as const;
