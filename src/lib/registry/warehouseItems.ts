...
export const WAREHOUSE_ITEMS: readonly WarehouseItem[] = [
  ...
  { id: "W-202", name: "时差症候群的表盘", description: "从 1F 扭曲时钟脱落的表盘。", benefit: "免疫时间扭曲4小时。", sideEffect: "指针倒转，影响时间感。", ownerId: "A-001", floor: "1" },
  { id: "W-203", name: "病历夹的金属扣", description: "病历本上的金属扣。", benefit: "账本信用+4约3小时。", sideEffect: "3小时后升温烫伤。", ownerId: "N-002", floor: "2" },
  { id: "W-204", name: "走廊的挂历残页", description: "一页被撕下的挂历。", benefit: "锚定时间感2小时。", sideEffect: "日期会变成你生日。", ownerId: "A-001", floor: "1" },
  { id: "W-205", name: "药柜的干燥剂", description: "药柜中的硅胶干燥剂。", benefit: "延缓水源凝聚诡异3小时。", sideEffect: "吸够湿气后现出眼球。", ownerId: "N-002", floor: "2" },
  { id: "W-206", name: "影子延迟的残影", description: "时差症候群的延迟影子碎片。", benefit: "下一次攻击推迟，争取撤离。", sideEffect: "影子脱离身体，2小时内需找回。", ownerId: "A-001", floor: "1" },
  // === 3 楼 6 件 ===
  ...
  { id: "W-404", name: "管道屠夫的骨渣", description: "2F 管线凝聚体脱落的骨渣。", benefit: "撒水源污染管道，液态诡异3小时内无法凝聚。", sideEffect: "2小时内会生长，需清理。", ownerId: "A-004", floor: "2", forgeTags: ["pollution", "sealant"], materialValue: 2, compatibleOperations: ["repair", "infuse"] },
  ...
  { id: "W-705", name: "调查员的暗码表", description: "前调查员用的密码对照表。", benefit: "破译1次加密信息，账本信用+8约3小时。", sideEffect: "部分记忆被加密24小时。", ownerId: "N-019", floor: "7" },
  { id: "W-706", name: "门扉内的呼唤残响", description: "13楼门内传出的声音残片。", benefit: "吸引门扉注意，为他人争取撤离。", sideEffect: "听久会被门扉标记。", ownerId: "A-007", floor: "7" },
  { id: "W-707", name: "消化日志的目录页", description: "记录消化进度的目录。", benefit: "获知当前消化阶段，账本信用+5约2.5小时。", sideEffect: "目录会新增一条是你。", ownerId: "N-011", floor: "7" },
  ...
  { id: "W-B202", name: "出口通道的锈迹", description: "B2 出口木门外侧封锁件上剥落的锈迹；不来自木门本体。", benefit: "暴露暗号残痕，削弱普通封锁，并制造一次撤退窗口；不能破坏出口木门。", sideEffect: "锈迹蔓延到下一个触碰的金属，可能让普通门锁提前卡死。", ownerId: "A-008", floor: "B2" },
