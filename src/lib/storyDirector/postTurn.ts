...
export function normalizeDirectorState(
  ...
  return {
    ...
    recentIncidentCodes: Array.isArray(o.recentIncidentCodes) ? uniq(o.recentIncidentCodes as string[], 10) : [],
    recentPeakTurn: clampInt(o.recentPeakTurn, 0, 999999),
    cooldowns: o.cooldowns && typeof o.cooldowns === "object" && !Array.isArray(o.cooldowns) ? (o.cooldowns as Record<string, number>) : {},
