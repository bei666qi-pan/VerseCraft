...
export const ANALYTICS_EVENT_TAXONOMY = {
  ...
  director_directive_receipt: c("director_directive_receipt", "content_quality", "Writer reported whether the current projected Director directive was used.", sessionIdentity, ["requestId", "directiveId", "status"], ["reasonCode"], "world-engine"),
