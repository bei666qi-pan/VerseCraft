...
export function buildResumeShadowSnapshot(state: Record<string, unknown>): ResumeShadowSnapshot {
  ...
  return {
    ...
    currentBgm: typeof state.currentBgm === "string" && state.currentBgm ? state.currentBgm : "bgm_b1_daily",
    stats,
...
export function readResumeShadowSnapshot(): ResumeShadowSnapshot | null {
  ...
  try {
    ...
    return {
      ...
      currentBgm: typeof obj.currentBgm === "string" && obj.currentBgm ? obj.currentBgm : "bgm_b1_daily",
