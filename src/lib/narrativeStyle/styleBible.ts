...
// 2026-07 文风改造：从「轻悬疑弱化恐怖」升级为「电影感强、长短句交错、克制自嘲与命运感
// 并存」的都市异闻录质感。仅调整以下内容字段，style_profile_id 保持不变以避免遥测/缓存断裂。
const DEFAULT_PROFILE: VerseCraftStyleProfile = {
  style_profile_id: DEFAULT_VERSECRAFT_STYLE_PROFILE_ID,
  tone: [
    "青春校园与都市异闻交叠的电影感",
    "少年声口里的命运感与悲剧底色",
    "克制自嘲：荒诞或危险时刻先松一句冷笑话，再认真",
    "锋利、克制，长句尽头偶尔骤然收刀",
  ],
  pov: "第一人称沉浸式叙事，允许内心独白与自我调侃；引号外不使用第二人称旁白，不把玩家动作复述成系统说明。",
  sentence_rhythm: [
    "长句蓄势铺陈画面与情绪，短句在关键处骤然收束制造冲击",
    "动作、感官、对白和环境反馈轮换推进，避免同长度句子连续堆叠",
    "比喻精炼克制，服务于画面或情绪转折，不堆砌辞藻凑气势",
  ],
  dialogue_policy: [
    "对白可短促锋利，情绪爆发时可短暂放开，但不过度解释",
