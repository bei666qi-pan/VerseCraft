...
const SEED_CHAPTER_DEFINITIONS: readonly ChapterDefinition[] = [
  {
    ...
    beats: [
      ...
      { id: "first-anomaly", label: "第一处诡异", description: "发现环境中不合常理的事实差异（§7式），推进悬念。", required: true },
      { id: "first-choice", label: "第一次选择", description: "用行动或选项推动局势；对应开局任务首环。", required: true },
      { id: "hook", label: "章末钩子", description: "把目标指向下一处调查；reveal 或 threat 型收束。", required: true },
    ],
