// src/lib/ai/tools/mechanicsToolSchemas.ts
/**
 * Mechanics Workflow 工具 JSON Schema 定义
 *
...
import type { MechanicsToolMeta, MechanicsToolCategory, MechanicsToolAccess } from "./mechanicsTypes";
...
): { meta: MechanicsToolMeta; parameters: Record<string, unknown> } {
  return {
    meta: {
      name,
      description,
...
/** 所有 Mechanics Workflow 工具的 Schema 注册表 */
export const MECHANICS_TOOL_SCHEMAS = {
  // Read-only tools
...
export type MechanicsToolName = keyof typeof MECHANICS_TOOL_SCHEMAS;

/** 所有工具名称列表 */
export const ALL_MECHANICS_TOOL_NAMES = Object.keys(MECHANICS_TOOL_SCHEMAS) as MechanicsToolName[];

/** 只读工具名称列表 */
export const READONLY_MECHANICS_TOOL_NAMES: MechanicsToolName[] = [
  "get_player_state",
  "get_inventory",
  "get_active_quests",
  "get_world_context",
...
/** 状态变更工具名称列表 */
export const WRITE_MECHANICS_TOOL_NAMES: MechanicsToolName[] = [
  "issue_quest",
  "update_quest_progress",
  "forge_weapon",
  "consume_materials",
