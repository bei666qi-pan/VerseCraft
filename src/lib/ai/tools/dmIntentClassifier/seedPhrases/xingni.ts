// src/lib/ai/tools/dmIntentClassifier/seedPhrases/xingni.ts
//
// 星逆·太初 DM Agent mechanics 意图种子短语清单。
...
//
//  与 dmMechanicsIntentRouter.ts 的 STRONG_MECHANICS_SIGNALS 相比，本表补充了星逆
