// src/lib/ai/tools/dmIntentClassifier/seedPhrases/darkMoon.ts
//
// 暗月（序章·暗月）DM Agent mechanics 意图种子短语清单。
...
//
//  与 dmMechanicsIntentRouter.ts 的 STRONG_MECHANICS_SIGNALS 列表保持同义集合；
