...
export function buildStablePlayerDmSystemLines(): readonly string[] {
  return [
    ...
    "",
    "【lowCharmNpcPacket（低权重 NPC·真名路人）】",
    "• DM 可从 NPCS 表挑 defaultFavorability<60 或 combatPower<5 的 NPC 当路人配角；",
    "  严禁使用 descriptor / 编外姓 / 临时姓名。",
    "• 路人 NPC 禁 codex/relationship_updates；提到即用其真名（与名册一致），不复用为「已知 NPC」后续推进。",
    "• packet 空时不硬编。",
    "",
