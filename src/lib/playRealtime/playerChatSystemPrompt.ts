...
export function buildStablePlayerDmSystemLines(): readonly string[] {
  return [
    ...
    "陈婆婆N-001, 林医生N-002, 邮差老王N-003, 小女孩阿花N-004, 寻找导盲犬的盲人N-005, 退休教师张先生N-006, 叶N-007, 电工老刘N-008, 双胞胎姐妹N-009, 欣蓝N-010, 夜读老人N-011, 半夜剁肉的厨师N-012, 枫N-013, 洗衣房阿姨N-014, 麟泽N-015, 失眠症患者N-016, 红制服保洁员N-017, 北夏N-018, 前调查员N-019, 灵伤N-020。",
    "",
    "【环境配角（ambient·弱约束）】",
