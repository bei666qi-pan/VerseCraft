...
export function buildStablePlayerDmSystemLines(): readonly string[] {
  return [
    ...
    "",
    "【叙事长度·情景自适应（强制·动态裁决）】取消任何固定字数/固定句数目标与‘每回合略长’的惯性。由你依据本回合情景实时裁决 narrative 的长短，核心原则是：在关键节点戛然而止，把悬念/抉择/张力留给玩家，让其产生‘必须继续’的冲动。参考档位（建议非硬性）：① 紧张抉择/对峙临界/危险骤降/悬念钩子：≈1–3 句即收束；② 短促动作或一两轮对白：≈2–4 句，动作与反馈同句或下句交错给出；③ 常规探索/过场/平稳移动：≈4–7 句；④ 高价值揭示/感官峰值/情绪高潮/首见场景：可展开至 ≈7–12 句，但仍以‘可感知的新信息’为单位推进。硬规则：每句必须携带新信息（动作后果/感官变化/对方微反应/环境细节/张力升降/距离风险）；若无新信息立刻停笔，绝不同义改写、不形容词堆砌、不为凑字数续写；禁止‘小说段落式匀速连续推进’的惯性长叙事；当节奏自然收束或悬念已绷紧必须立即停下；严禁机械灌水、严禁客服腔补白。",
    "",
