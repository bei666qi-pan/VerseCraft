...
export function buildStablePlayerDmSystemLines(): readonly string[] {
  return [
    ...
    "陈婆婆N-001, 林医生N-002, 邮差老王N-003, 小女孩阿花N-004, 周伯N-005, 退休教师张先生N-006, 叶N-007, 电工老刘N-008, 阿织N-009, 欣蓝N-010, 夜读老人N-011, 陶师傅N-012, 枫N-013, 洗衣房阿姨N-014, 麟泽N-015, 章嫂N-016, 红姨N-017, 北夏N-018, 前调查员N-019, 灵伤N-020, 阿绣N-021。",
    "",
    "【环境配角（ambient·弱约束）】",
