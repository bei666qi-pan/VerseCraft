...
function buildSystemPrompt(playerContext: string, isFirstAction: boolean): string {
  const base = [
    ...
    '{ "is_action_legal": boolean, "sanity_damage": number, "narrative": "以第一人称视角推进的恐怖悬疑剧情，不要有任何多余的废话", "is_death": boolean, "consumes_time": boolean, "consumed_items": ["消耗掉的道具名称"], "codex_updates": [可选], "awarded_items": [可选], "options": ["选项1", "选项2", "选项3", "选项4"] }',
    "",
