...
const STAT_DESCRIPTIONS: Record<StatType, string> = {
  sanity:
    "<0即死亡。理智越高越难陷入幻象。质变：理智>20时，玩家在探索时有极大概率发现隐藏道具并获取规则提醒。",
  agility:
    '敏捷越高，你的叙事(narrative)必须越长、越丰富，且玩家越容易从诡异/恶意NPC手中逃脱。质变：敏捷>20时，玩家有一定概率触发"极速反应"，此时你必须在返回的 JSON 中设置 "consumes_time": false，让玩家本次行动不消耗时间。',
  luck:
    "幸运越高，越容易遇到正向事件，越难遇到恶意实体，极易发现道具。质变：幸运>20时，玩家的普通探索有可能直接发现A级/S级道具的线索，或直接看破当前楼层诡异的必杀规则。",
  charm:
    "魅力越高，越容易获取NPC好感，更难引起诡异注意。质变：魅力>20时，中立NPC极有可能主动出手相助，甚至诡异在必杀判定时有概率放玩家一条生路。",
  background:
    "出身越高，开局自带的道具越好（最高A级）。质变：出身>20时，玩家开局即可能有一名原世界观中的NPC全程协助，或有1只诡异（非B2守门人）天生认识玩家并愿意提供帮助。",
};
...
const TALENTS: readonly {
  ...
  { key: "生命汇源", title: "生命汇源", cd: "CD：5 小时", desc: "将理智恢复至满值（50）。" },
