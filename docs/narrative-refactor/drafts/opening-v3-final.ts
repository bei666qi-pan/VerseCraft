/**
 * Refined candidate A for FIXED_OPENING_NARRATIVE — phase-3 selected winner
 *
 * Changes from baseline:
 * - Similes cut from 13 → 2 (only "粉笔灰薄薄洒了一层" and "针一样扎着")
 * - Extended B1 section with more sensory detail and "我" voice
 * - Added self-deprecating humor ("我以前在贴吧写过两篇烂尾小说" — 我觉得这次不行)
 * - Ending: stronger threat hook with ten-day window + physical reaction
 * - ~1490 chars, single paragraphs ≤100 chars
 */

export const FIXED_OPENING_NARRATIVE_V3 = `夕阳斜斜地压在黑板上，粉笔灰薄薄洒了一层。老师的声音在教室里来回反弹，平得让人犯困。
