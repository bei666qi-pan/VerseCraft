...
- **它的目标是平台，不是单一故事页面**：今天可以是怪谈，未来也可以是悬疑、校园、赛博、末日。
...
- 规则会变化，也会惩罚。
- 时间会推进，危险会抬升。
- 到了“暗月”阶段，整栋公寓会变得更不讲理。
- 你能做的只有继续判断、继续试探、继续活下去。

这是 VerseCraft 的第一块内容样板，也是平台概念的第一部“可进入、可操作、可被 AI 推进”的互动小说世界。
...
VerseCraft 是一个单机、浏览器内运行的中文互动叙事项目。它目前以「序章·暗月」为起始世界，围绕 AI 叙事推进、规则检定、世界知识检索和客户端持久化来搭建平台原型。
