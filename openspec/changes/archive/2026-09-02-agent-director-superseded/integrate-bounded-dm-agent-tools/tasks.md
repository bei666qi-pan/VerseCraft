...
- [-] **T1: Add `shouldAttemptDmAgent()` routing gate in route.ts**
...
- [-] **T2: Fix `agentUsed` semantics in dmAgentRouteIntegration.ts**
...
- [-] **T3: Remove FINAL bypass — add full final chain to DM Agent path**
...
- [-] **T4: Verify feature flag off behavior**
...
- [-] **T5: Lint passes** — `npx eslint src/app/api/chat/route.ts` clean
- [-] **T6: Unit tests pass** — 143 tests across 21 suites pass
