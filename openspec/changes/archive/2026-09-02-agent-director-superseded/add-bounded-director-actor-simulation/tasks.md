...
- [-] **T1: Define Actor Simulation types**
...
- [-] **T3: Implement Actor Input Builder**
...
- [-] **T4: Implement Projection Validator**
...
- [-] **T5: Implement Feature Flag Config**
...
- [-] **T6: Implement Bounded Actor Simulator**
...
- [-] **T7: Implement Director Synthesizer**
  - Pure function, no IO
...
- [-] **T8: Wire into World Engine Tick**
...
- [-] **T10: validateProjection tests** — 10 tests, 0 failures
- [-] **T11: actorSimulator tests** — 19 tests (prompt, parsing, telemetry), 0 failures
- [-] **T12: directorSynthesizer tests** — 11 tests (conflicts, filtering, hints), 0 failures

### Verification

- [-] **T13: TypeScript compiles cleanly** — 0 errors in actorSimulation/*
- [-] **T14: ESLint clean** — 0 errors, 0 warnings in actorSimulation/*
- [-] **T15: Unit test suite** — 40 tests, 0 failures
