...
Define a trustworthy, non-mutating evaluation and regression workflow that produces evidence and explicit implementation handoffs without autonomously changing repository code.
